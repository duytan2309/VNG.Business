...
namespace VNG.Business.Entities.Public
{
    public class NhapKho
    {
        ...
        public string SoHoaDon_Den { get; set; }
        public DateTime? NgayHoaDon_Den { get; set; }
        ...
        public string CodeThung { get; set; }
        public string GhiChu { get; set; }
        public string DienGiai { get; set; }
        public string UserNhapKho { get; set; }
